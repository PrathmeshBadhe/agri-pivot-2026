...
export const CalculatorPage = () => {
    ...
    useEffect(() => {
        ...
        if (saved) {
            try {
                ...
                if (parsed.vehicle) setSelectedVehicle(parsed.vehicle);
    ...
    useEffect(() => {
        const state = { price, quantity, distance, vehicle: selectedVehicle, unit };
        sessionStorage.setItem('calc_state', JSON.stringify(state));
        ...
        <div className="min-h-screen bg-slate-50 relative">
            ...
            <div className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-200 px-4 py-3 mb-6">
                <div className="max-w-lg mx-auto flex items-center gap-4">
                    <Link to="/" className="p-2 -ml-2 hover:bg-slate-100 rounded-full transition-colors text-slate-600 font-medium flex items-center gap-1">
